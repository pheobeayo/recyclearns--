...
const EditProduct = ({ id }) => {
  ...
  return (
    <div>
      <div className="">
        <button
          className="bg-[#015C28] py-2 text-white mb-4 ppx-4 rounded-lg lg:text-[20px] md:text-[20px] font-bold text-[16px] w-[100%] my-2 hover:bg-bg-ash hover:text-darkGrey hover:font-bold"
          onClick={handleOpen}
        >
          Edit Information
        </button>
        {showUpload && (
          ...
          >
            <Box sx={style}>
              ...
              <button
                className="bg-white text-[#427142] py-2 px-4 rounded-lg font-bold text-[16px] w-[100%] my-2 hover:bg-bg-ash hover:text-darkGrey hover:font-bold"
        ...
        {showForm && (
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-75">
            <div className="p-8 rounded-lg text-[#0F160F] flex flex-col items-center bg-[#2a2a2a] lg:w-[30%] md:w-[30%] w-[90%] mx-auto">
              <IoClose
                className="self-end mb-4 font-bold text-2xl text-white"
